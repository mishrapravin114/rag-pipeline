...
export function VirtualDrugList({
  collectionId,
  collectionName,
  onDrugClick,
  className,
  ...
  const DrugItem = React.memo(({ index, style }: { index: number; style: React.CSSProperties }) => {
    const drug = drugs[index];
    
    // Return empty if no drug (shouldn't happen with current setup)
    if (!drug) {
