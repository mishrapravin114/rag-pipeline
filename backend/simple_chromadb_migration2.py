#!/usr/bin/env python3
"""
Simple ChromaDB to Qdrant migration script focusing on collection_30_hta_swedish.
"""
...
def migrate_collection_30_hta_swedish():
    """Migrate collection_30_hta_swedish from ChromaDB to Qdrant."""
    ...
    try:
        ...
        source_collection = client.get_collection("collection_30_hta_swedish")
        ...
        target_collection_name = "collection_30_hta_swedish"
...
if __name__ == "__main__":
    print("🚀 Starting collection_30_hta_swedish migration...")
    result = migrate_collection_30_hta_swedish()
